...
export const metadata: Metadata = {
  title: "Contacto",
  description:
    "Contacta con TenisLand para consultas sobre nuestros productos, servicios o para solicitar asesoramiento personalizado sobre artículos deportivos.",
};
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <ul className="space-y-4 text-gray-700">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-3 text-[#0B315B] mt-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                ...
                <div>
                  ...
                  <a
                    ...
                    className="hover:text-[#0B315B] transition"
                  >
                    +54 11 5555-5555
                  </a>
                </div>
            ...
            <ul className="space-y-3 text-gray-700">
              <li>
                <a
                  ...
                  className="flex items-center hover:text-[#0B315B] transition"
                >
                  <svg
        ...
        <div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700 mb-6">
              Completá el formulario y nos pondremos en contacto contigo lo
              antes posible.
            </p>
